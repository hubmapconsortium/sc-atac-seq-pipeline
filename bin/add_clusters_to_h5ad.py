...
def main(
    ...
    cell_by_bin_h5ad: Path,
    cell_by_gene_h5ad: Path,
    bin_size: int,
):
...
if __name__ == "__main__":
    ...
    p.add_argument("cell_by_bin_h5ad", type=Path)
    p.add_argument("cell_by_gene_h5ad", type=Path)
    p.add_argument("bin_size", type=int)
    args = p.parse_args()

    main(
        umap_coords_csv=args.umap_coords_csv,
        cell_by_bin_h5ad=args.cell_by_bin_h5ad,
        cell_by_gene_h5ad=args.cell_by_gene_h5ad,
